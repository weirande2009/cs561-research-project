...
std::string FileSerializer::Serialize(const rocksdb::FileMetaData* file) {
    FileTag tag;
...
bool FileSerializer::IsSameVersion(std::vector<std::string>& version1, std::vector<std::string>& version2) {

...
public:
    ...
    */
     ...
     * @param new_compaction_time: the newly computed compaction time
    */
    ...
    */
     ...
     * @param index index of the version to be chosen to compact
    */
    void CollectCompactionInfo(int level, 
